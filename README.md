...
Scrapes popular CDN catalogs, downloads every listed `.js` and `.css` file, and
...
3. **Ranking** — batch-query the
   ...
   take the top 100, and hash all `.js`/`.css` files for each package's latest
   cdnjs version.
