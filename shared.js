...
export function formatHashList({ core, huggingface = [], version, commit }) {
  const header = [
    ...
    '// Generated by hosted-libraries-sha256-hasher',
    '// https://github.com/tomayac/hosted-libraries-sha256-hasher',
    '//',
    `// VERSION: ${version}`,
    `// COMMIT: ${commit}`,
